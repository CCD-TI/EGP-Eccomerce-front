...
export default function PaymentFlow({
  ...
  return (
    <div className="h-screen flex items-center  text-white p-4 md:p-6  overflow-x-auto scrollbar-hide  bg-double-esferas2 ">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 w-full mx-auto">
          ...
          <div className="flex-1">
            {currentStep === "method" && (
              <div>
                ...
                <div className=" bg-gradient-to-br from-[rgba(0,96,254,0.4)] hover:from-[rgba(0,96,254,0.7)] via-[rgba(22,46,84,0.5)] hover:via-[rgba(22,46,84,0.7)] 
            ...
            {currentStep === "form" && (
              <div className="flex flex-col items-center max-lg:mt-[45rem]">
               ...
               <button
                ...
                <div className="flex  justify-center bg-gradient-to-br from-[rgba(0,96,254,0.4)] hover:from-[rgba(0,96,254,0.7)] via-[rgba(22,46,84,0.5)] hover:via-[rgba(22,46,84,0.7)] 
          ...
          <div className="lg:w-[550px]">
            ...
            <div className=" rounded-3xl p-6 backdrop-blur-sm">
              <div className="flex  max-sm:flex-col items-center gap-4 mb-6  bg-gradient-to-br from-[rgba(0,96,254,0.4)] hover:from-[rgba(0,96,254,0.7)] via-[rgba(22,46,84,0.5)] hover:via-[rgba(22,46,84,0.7)] 
