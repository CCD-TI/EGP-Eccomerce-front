...
const PacksSection = () => {
  ...
  return (
    <>
      <div className=" h-screen max-[1765px]:h-[80vh] max-2xl:h-[70vh] max-xl:h-full  bg-colors-night-blue-ccd2  py-16 flex items-center justify-center bg-double-image max-xl:bg-double-esferas2 ">
        <div className="max-w-[100rem] w-[90%] h-full mx-auto max-lg:w-full flex flex-col justify-center items-end max-xl:items-center scale-95">
          {/* Título principal */}
          <div className="w-fit flex flex-col justify-center items-center">
            <div className="text-center">
              <h1 className="text-3xl font-extrabold text-white">
                Obten{" "}
                <span className="text-3xl text-colors-cyan-ccd">
                  {" "}
                  acceso total{" "}
                </span>
                a <br /> todas nuestras rutas
              </h1>
            </div>
                ...
                <div className="group bg-gradient-to-t from-colors-cyan-ccd to-colors-dark-blue-ccd shadow-lg p-6 w-[300px] rounded-2xl border-2 border-white hover:shadow-[0_0_15px_7px_rgba(0,234,223,0.4)] transition duration-300 hover:scale-105">
                  ...
                  <ul className="mt-4 space-y-2 text-white">
                    <li className="flex items-center text-lg">
                      <FaCircleCheck className="mr-2 text-white" />1 Año de
                      acceso total
                    </li>
                    <li className="flex items-center text-lg">
