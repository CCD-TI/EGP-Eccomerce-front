...
const ShoppingCartCourseSelector: React.FC<{
  precioplan: number;
  idplan: number;
}> = ({ precioplan, idplan }) => {
  ...
  // Estado para manejar el tipo de ordenamiento
  ...
  useEffect(() => {
    ...
    // 🔹 Ordenar según la opción seleccionada en el dropdown
    if (sortOption === "Fecha") {
  ...
  const handlePaymentMethodSelect = (method: "card" | "qr") => {
    if (selectedCourses.length !== 2) {
      const htmlMessage = "El plan BÁSICO requiere seleccionar 2 cursos.";
  ...
  const handleBoxToggle = (courseId: number) => {
    ...
    if (isAlreadySelected) {
      ...
      if (
        (selectedCourse.TipoModalidad === "En Vivo" && liveCoursesCount >= 1) ||
        (selectedCourse.TipoModalidad === "Asincrónico" &&
          asyncCoursesCount >= 1)
      ) {
        showModal(
          "Debe seleccionar exactamente un curso de cada modalidad 'Asincrónico' y 'En Vivo' ."
        );
        return;
      }
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 w-full mx-auto">
          ...
          <div className="flex-1">
            {currentStep === "method" && (
              <>
                <div className="flex flex-col justify-center items-center">
                  <div className="w-full py-4 px-2 flex flex-col items-center justify-center gap-10">
                    {/* Sección de Opciones */}
                ...
                <div className="flex items-start justify-center gap-10">
                  ...
                  <div className="flex-1">
                    {/* START Filtros */}
                    <div className="flex justify-between max-md:flex-col mb-6 max-md:gap-4 z-50">
                      <div className="flex max-xl:flex-col gap-4">
                        ...
                        <div className="py-2">
                          <div className="flex items-center gap-4">
                            <Switch
                              ...
                              classNames={{
                                wrapper:
                                  "border-[#00EADE] border-1 bg-[#131939]",
                              }}
                            ></Switch>
                            {modalidad == "En Vivo" ? (
                              <>
                        ...
                        <div className="w-fit sticky top-0 z-50 py-2">
                          ...
                          {isOpen2 && (
                            <ul className="absolute z-50 mt-2 w-max rounded-[8px] shadow-lg text-white bg-[#131939]">
                              <li
                        ...
                        {/* <Select
                          ...
                          classNames={{
                            base: " bg-colors-dark-blue-ccd text-white rounded-2xl", 
                            trigger: " bg-colors-dark-blue-ccd  text-white  hover:!bg-blue-900 hover:!text-gray-300", 
                            listbox: " bg-colors-dark-blue-ccd text-white ", 
                            popoverContent: " bg-colors-dark-blue-ccd text-white shadow-lg  ",
                            value: "!text-white",
                            label: "!text-white"
                      ...
                      >
                        <div className="relative">
                          <input
                            ...
                            value={searchTerm}
                            onChange={(e) => setSearchTerm(e.target.value)} // 🔹 Se actualiza en tiempo real
                          ...
                          <button
                            ...
                            className="absolute right-3 top-[50%] focus:border-colors-dark-blue-ccd p-2 -translate-y-[50%] rounded-full transition duration-500"
                          >
                      ...
                      (producto: CursoDetalle, index: number) => {
                        ...
                        return (
                          <>
                            <div
                              key={index}
                              className="flex max-sm2:flex-col items-center gap-4 pl-5 py-4 px-6 mb-4 rounded-xl bg-[#131939] hover:bg-[#1B2551] transition "
                            >
                  ...
                  <div className="w-[30%] bg-[#131939] rounded-2xl p-6 h-fit sticky top-6 max-xl:hidden">
                  ...
                  <div className="hidden max-xl:flex fixed right-16 bottom-14   max-sm:right-8">
                    <Sheet>
                      ...
                      <SheetContent className="w-[80%] bg-[#131939]">
                        <SheetClose asChild>
                          <button
                            className="p-4 rounded-2xl"
                          
                          >
                            <FaArrowLeft className="text-2xl text-colors-sky-ccd" />
                          </button>
                        </SheetClose>
                        <div className="w-full bg-[#131939] rounded-2xl p-6 h-fit sticky top-6 ">
                          <h3 className="text-lg text-white mb-2">
                            Mi Plan{" "}
                            <span className="text-colors-sky-ccd font-bold text-lg">
                              BÁSICO
            ...
            {currentStep === "form" && (
              <div className="flex flex-row-reverse items-start justify-center gap-16 h-full  max-lg:flex-col ">
                <div className="flex flex-col  ">
                  <div
                  ...
                  >
                    <div className="flex justify-between items-center w-full mb-2">
                      <h1 className="text-xl">
                        Mi Plan{" "}
                        <span className="text-colors-sky-ccd text-xl font-bold">
                          BÁSICO
                        </span>
                      </h1>
...
export default ShoppingCartCourseSelector;
