...
const ShoppingCartProfesional: React.FC<{
  ...
  const handlePaymentMethodSelect = (method: "card" | "qr") => {
    if (selectedCourses.length !== 4) {
      const htmlMessage =
        'El plan PREMIUN requiere seleccionar 4 cursos.';
    ...
    if (isAlreadySelected) {
      ...
      setcursosCompletos((prevCursos) =>
        prevCursos.map((curso) =>
          curso.IdProducto === courseId ? { ...curso, isSelected: false } : curso
        )
      );
    } else {
      ...
      if (
        ...
        (selectedCourse.TipoModalidad === "Asincrónico" && asyncCoursesCount >= 2)
      ) {
        showModal("Debe seleccionar exactamente dos cursos de cada modalidad 'Asincrónico' y 'En Vivo' .");
        return;
      }
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 w-full mx-auto">
          ...
          <div className="flex-1">
            {currentStep === "method" && (
              <>
                <div className="flex flex-col justify-center items-center">
                  ...
                  <div className="w-full py-10 px-6 flex flex-col items-center justify-center gap-10">
                    {/* Sección de Opciones */}

                    <div className="grid grid-cols-3 max-md:grid-cols-1 grid-rows-2 gap-4 ">
                      <div>
                        {/* Gestión */}
                        <div
                    ...
                    <div className="flex justify-between max-md:flex-col mb-6 max-md:gap-4">
                      <div className="flex max-xl:flex-col gap-4">
                        ...
                        <div className="w-64">
                          ...
                          {/* Opciones */}
                          {isOpen2 && (
                            <ul className="absolute z-10 mt-2 w-max bg-[#131939] rounded-[8px] shadow-lg text-white">
                              <li
            ...
            {currentStep === "form" && (
              <div className="flex justify-center gap-6 h-full  max-md:flex-col ">
