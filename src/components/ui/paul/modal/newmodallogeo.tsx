...
export default function ModalLogeoComponent({ array }: Props) {
  ...
  const img = {
    logos: {
      logo: `${storageUrl}/Multimedia/Imagen/Ccd/Logos/acreditacion-cdd-white5.svg`
    },
  };
...
<html lang="es">
  <head>
    ...
    <style>
      ...
      .footer {
        background: linear-gradient(to right, #131939, #3d7bdf);
        color: white;
        text-align: center;
        padding: 20px;
      }
  ...
  <body>
    <div class="container">
      ...
      <section class="content">
        <h2>
          Bienvenid@!, <br /><span class="customer-name"
            >${ pnombres + " " + papellidos }</span
          >
        </h2>
