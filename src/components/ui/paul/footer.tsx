      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-6 lg:px-14">
        ...
        <div>
         ...
         <Link href="/https://www.facebook.com/ccd.capacitacion">Facebook</Link>
          ...
          <Link href="/https://www.youtube.com/channel/UCkUcUqz1EH9xEsogvVF92oA">Youtube</Link>
          <span className="mx-2">|</span>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <MdMenuBook className="text-colors-cyan-ccd size-8" />
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSflruyCMzI379rVSbtcawNZunN7WDlYcoZQ9cxB6Szz5mjloA/viewform" target="_blank" className="hover:underline">
        ...
        <div className="text-center pt-4 -pb-2 -mb-2">Copyright {currentYear} - Empresa: CENTRO DE CAPACITACION Y DESARROLLO S.A.C. - RUC: 20606101911</div>
    </footer>
    </>
  );
};
