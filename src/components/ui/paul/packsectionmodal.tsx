  ...
  return (
    ...
    >
      ...
      >
        ...
        border-white hover:shadow-[0_0_15px_7px_rgba(49,133,247,0.5)] transition 
        duration-300 hover:scale-105"
          >
            ...
            <ul className="mt-2 space-y-1 text-white">
              <li className="flex items-center font-sans text-sm">
            ...
            <p className="text-2xl font-extrabold text-center text-white">
              <span className="relative top-[-15px] text-lg">S/</span>
              699.99
            </p>
...
export default PacksSectionModal;
